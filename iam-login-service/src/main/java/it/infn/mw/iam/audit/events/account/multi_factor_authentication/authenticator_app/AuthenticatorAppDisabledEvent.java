...
public class AuthenticatorAppDisabledEvent extends AccountEvent {

  public static final String TEMPLATE = "Account '%s' has disabled MFA through authenticator app";
