CREATE TABLE iam_account (ID BIGINT IDENTITY NOT NULL, active BOOLEAN NOT NULL, CREATIONTIME TIMESTAMP NOT NULL, LASTUPDATETIME TIMESTAMP NOT NULL, PASSWORD VARCHAR(128), USERNAME VARCHAR(128) NOT NULL UNIQUE, UUID VARCHAR(36) NOT NULL UNIQUE, user_info_id BIGINT, mfa_enabled BOOLEAN NOT NULL, totp_mfa_id BIGINT, PRIMARY KEY (ID));
...
CREATE TABLE iam_totp_mfa (ID BIGINT NOT NULL, active BOOLEAN NOT NULL, CREATIONTIME TIMESTAMP NOT NULL, LASTUPDATETIME TIMESTAMP NOT NULL, secret VARCHAR(256), ACCOUNT_ID BIGINT, PRIMARY KEY (ID));
CREATE TABLE iam_totp_recovery_code (ID BIGINT NOT NULL, code VARCHAR(255) NOT NULL, CREATIONTIME TIMESTAMP NOT NULL, LASTUPDATETIME TIMESTAMP NOT NULL, TOTP_MFA_ID BIGINT NOT NULL, PRIMARY KEY (ID));
