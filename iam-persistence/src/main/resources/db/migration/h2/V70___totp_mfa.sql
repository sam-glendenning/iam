...
CREATE TABLE iam_totp_mfa (ID BIGINT IDENTITY NOT NULL, UUID VARCHAR(36) NOT NULL UNIQUE, active BOOLEAN NOT NULL, secret VARCHAR(256), ACCOUNT_ID BIGINT, PRIMARY KEY (ID));
