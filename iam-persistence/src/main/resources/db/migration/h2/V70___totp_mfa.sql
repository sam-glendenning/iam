...
CREATE TABLE iam_totp_mfa (ID BIGINT IDENTITY NOT NULL, active BOOLEAN NOT NULL, secret VARCHAR(256) NOT NULL, creation_time TIMESTAMP NOT NULL, last_update_time TIMESTAMP NOT NULL, ACCOUNT_ID BIGINT, PRIMARY KEY (ID));
