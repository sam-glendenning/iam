CREATE TABLE iam_account (ID BIGINT AUTO_INCREMENT NOT NULL, active TINYINT(1) default 0 NOT NULL, CREATIONTIME DATETIME NOT NULL, LASTUPDATETIME DATETIME NOT NULL, PASSWORD VARCHAR(128), USERNAME VARCHAR(128) NOT NULL UNIQUE, UUID VARCHAR(36) NOT NULL UNIQUE, user_info_id BIGINT, totp_mfa_id BIGINT, PRIMARY KEY (ID));
